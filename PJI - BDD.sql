-- Ana Beatriz Pires, Felipe Serikyaku, Pedro Bolgheroni, Vitória Medeiros, Camila Campos, Raissa Nunes
...
-- select codigo, nome, imagem, email from Interessado;

-- select codigo, genero, imagem_p, nome from Animal;

-- select nome from Interessado order by nome;

-- select nome from Animal order by nome;

-- select nome, email from Ong;

-- select nome from Raca order by nome;

-- select codigo, tipo_pix, num_pix from DadosBancarios;

-- select descricao from Depoimento order by data_depoimento;

-- select count(codigo) from Animal;

-- select * from Animal where genero like 'FÊMEA%';

-- select * from Animal where porte like 'GRANDE%';
...
/* DELIMITER CREATEFUNCTIONfnslug(nomeTEXT)RETURNSTEXTDETERMINISTICBEGINDECLAREresultadoTEXT;SETresultado=REPLACE(nome,′.′,′′);SETresultado=REPLACE(resultado,′′,′−′);SETresultado=REPLACE(resultado,′−−′,′−′);SETresultado=REPLACE(resultado,′\'′,′−′);SETresultado=REPLACE(resultado,′œ′,′oe′);SETresultado=REPLACE(resultado,′€′,′euro′);SETresultado=REPLACE(resultado,′$′,′dollars′);SETresultado=REPLACE(resultado,′£′,′′);SETresultado=TRIM(resultado);SETresultado=REPLACE(resultado,′à′,′a′);SETresultado=REPLACE(resultado,′á′,′a′);SETresultado=REPLACE(resultado,′â′,′a′);SETresultado=REPLACE(resultado,′ã′,′a′);SETresultado=REPLACE(resultado,′ä′,′a′);SETresultado=REPLACE(resultado,′å′,′a′);SETresultado=REPLACE(resultado,′æ′,′a′);SETresultado=REPLACE(resultado,′è′,′e′);SETresultado=REPLACE(resultado,′é′,′e′);SETresultado=REPLACE(resultado,′ê′,′e′);SETresultado=REPLACE(resultado,′ë′,′e′);SETresultado=REPLACE(resultado,′ì′,′i′);SETresultado=REPLACE(resultado,′í′,′i′);SETresultado=REPLACE(resultado,′î′,′i′);SETresultado=REPLACE(resultado,′ï′,′i′);SETresultado=REPLACE(resultado,′ð′,′o′);SETresultado=REPLACE(resultado,′ñ′,′n′);SETresultado=REPLACE(resultado,′ò′,′o′);SETresultado=REPLACE(resultado,′ó′,′o′);SETresultado=REPLACE(resultado,′ô′,′o′);SETresultado=REPLACE(resultado,′õ′,′o′);SETresultado=REPLACE(resultado,′ö′,′o′);SETresultado=REPLACE(resultado,′ø′,′o′);SETresultado=REPLACE(resultado,′ù′,′u′);SETresultado=REPLACE(resultado,′ú′,′u′);SETresultado=REPLACE(resultado,′û′,′u′);SETresultado=REPLACE(resultado,′ý′,′y′);SETresultado=REPLACE(resultado,′ý′,′y′);SETresultado=REPLACE(resultado,′þ′,′b′);SETresultado=REPLACE(resultado,′ÿ′,′y′);SETresultado=REPLACE(resultado,′ƒ′,′f′);SETresultado=REPLACE(resultado,′À′,′A′);SETresultado=REPLACE(resultado,′Á′,′A′);SETresultado=REPLACE(resultado,′Â′,′A′);SETresultado=REPLACE(resultado,′Ã′,′A′);SETresultado=REPLACE(resultado,′Ä′,′A′);SETresultado=REPLACE(resultado,′Å′,′A′);SETresultado=REPLACE(resultado,′È′,′E′);SETresultado=REPLACE(resultado,′É′,′E′);SETresultado=REPLACE(resultado,′Ê′,′E′);SETresultado=REPLACE(resultado,′Ë′,′E′);SETresultado=REPLACE(resultado,′Ì′,′I′);SETresultado=REPLACE(resultado,′Í′,′I′);SETresultado=REPLACE(resultado,′Î′,′I′);SETresultado=REPLACE(resultado,′Ï′,′I′);SETresultado=REPLACE(resultado,′Ò′,′O′);SETresultado=REPLACE(resultado,′Ó′,′O′);SETresultado=REPLACE(resultado,′Ô′,′O′);SETresultado=REPLACE(resultado,′Õ′,′O′);SETresultado=REPLACE(resultado,′Ö′,′O′);SETresultado=REPLACE(resultado,′Ù′,′U′);SETresultado=REPLACE(resultado,′Ú′,′U′);SETresultado=REPLACE(resultado,′Û′,′U′);SETresultado=REPLACE(resultado,′Ü′,′U′);SETresultado=REPLACE(resultado,′Ø′,′O′);SETresultado=REPLACE(resultado,′Æ′,′A′);SETresultado=REPLACE(resultado,′Ð′,′D′);SETresultado=REPLACE(resultado,′Ñ′,′N′);SETresultado=REPLACE(resultado,′Ý′,′Y′);SETresultado=REPLACE(resultado,′Þ′,′B′);SETresultado=REPLACE(resultado,′ß′,′S′);SETresultado=REPLACE(resultado,′ç′,′c′);SETresultado=REPLACE(resultado,′Ç′,′C′);SETresultado=REPLACE(resultado,′š′,′s′);SETresultado=REPLACE(resultado,′Ð′,′Dj′);SETresultado=REPLACE(resultado,′ž′,′z′);SETresultado=REPLACE(resultado,′Þ′,′B′);SETresultado=REPLACE(resultado,′ß′,′Ss′);SETresultado=CONCAT(′adotapets.com/′,resultado,′/animais′);RETURNLOWER(resultado);END
